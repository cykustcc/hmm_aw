...
//    float **u= &data;
//    double lhsum;
//    est_hmm_notdiag = hmmfit(u, 1, len, dim, numst, NULL, loglikehd, &lhsum, EPSILON, NULL, false);
//    est_hmm_diag = hmmfit(u, 1, len, dim, numst, NULL, loglikehd, &lhsum, EPSILON, NULL, true);
//    
